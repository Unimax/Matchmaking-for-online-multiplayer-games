...
build-mmf-go-deathmatch-image: docker build-base-build-image
	docker build -f examples/functions/golang/deathmatch/Dockerfile -t $(REGISTRY)/openmatch-mmf-go-deathmatch:$(TAG) -t $(REGISTRY)/openmatch-mmf-go-deathmatch:$(ALTERNATE_TAG) .
